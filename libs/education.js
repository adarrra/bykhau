...
let card2_1 = [
    ...
    },
    {
        pic: 'dev3.jpg',
        title: 'IT-Юрист', 
        descr: 'ЭТОТ КУРС ДЛЯ ВАС, ЕСЛИ ВЫ: Хотите получить реальный опыт работы в сфере IT и найти высокооплачиваемую работу. Хотите расширить свои знания юриспруденции и стать востребованным на рынке труда. Хотите грамотно продвигать свой проект и наладить прочные отношения с инвесторами.',
        link: 'it_jurist.html',
    },
];
...
let card6 = [
    {
        pic: 'mark1.png',
        title: 'Как войти в IT или как стать IT-специалистом с нуля', 
    ...
    {
        pic: 'mark2.png',
        title: 'Как найти работу в условиях кризиса',
        descr: 'Даже в самые непростые времена одни кандидаты ищут работу месяцами, а у других уже в первую неделю появляется несколько интересных предложений. Ключевым этапом в поиске работы является собеседование.',
