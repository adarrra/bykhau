...
let menu = [
    {
        ...
        descr: 'Хочешь получить востребованную в IT-профессию?',
        link: 'pages/incubator.html'
    },
    {
        title: 'Стартап лаборатория',
        descr: 'Хочешь создать и развивать свой бизнес?',
        link: 'pages/incubator.html#i3'
    },
    {
        title: 'Коворкинг',
        descr: 'Ищешь место для работы и деловых встреч?',
        link: 'pages/incubator.html#i1'
    },
    {
        title: 'Консультации',
        descr: 'Есть вопросы по созданию и ведению бизнеса?',
        link: 'pages/incubator.html#i3'
    },
];
