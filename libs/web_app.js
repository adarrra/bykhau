...
let cour = [
    ...
    {
        lesson: 'Занятие 5', 
        title: 'Ознакомление с языком JavaScript',
        descr: `
        <li>1. Способы подключения сценариев JavaScript. Типы данных, переменные, операторы, ввод-вывод данных.</li>
        <li>2. Языковые конструкции, организация ветвлений, выполнение вычислений. Объекты JavaScript. Методы объекта Math.</li>
        <li>3. Организация циклов, работа с массивами. Функции JavaScript. Области видимости переменных. События и обработчики событий.</li>
        <li>4. Отладка кода JavaScript: инструменты разработчика браузера.</li>
        `,
    },
    {
        lesson: 'Занятие 6', 
